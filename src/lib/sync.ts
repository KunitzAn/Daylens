 ...
 * сюда не входит, его запускает main.ts сразу после mount() — и именно
 * после, а не до: любое ожидание сети до монтирования вешало холодный
 * запуск офлайн на iOS (см. комментарий в main.ts).
 */
